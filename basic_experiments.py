...
'''
Descript:	Script that tries tf-idf vectorizer and basic classification 
			learners for sentiment analysis of movie reviews in Albanian.
Author:		Erion Çano
...
## train/test split
X_train = df_train["Review"].values.tolist()
X_test = df_test["Review"].values.tolist()
y_train = df_train["Polarity"].values.tolist()
